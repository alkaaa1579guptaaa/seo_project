...
const ServiceContactUs = () => {
  return (
    ...
    <div className="container mx-auto flex flex-wrap lg:flex-nowrap items-center justify-center gap-8">
      ...
      <div className="flex bg-gray-800 p-8 rounded-md shadow-lg items-center">
        ...
        {/* Right Section: Contact Form */}
         <div className="flex-1 flex flex-col items-center">
          <div className="text-center">
            ...
            We offer a comprehensive suite of services to help your business thrive in<br/>
            today’s competitive market. Discover how our expert solutions can support<br/>
